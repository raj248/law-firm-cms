...
electron.contextBridge.exposeInMainWorld("electronAPI", {
  getNotificationSoundPath: () => electron.ipcRenderer.invoke("get-notification-sound-path"),
...
electron.contextBridge.exposeInMainWorld("database", {
  ...
  deleteTag: (tagName) => electron.ipcRenderer.invoke("delete-tag", tagName),
  deleteCourt: (courtName) => electron.ipcRenderer.invoke("delete-court", courtName),
